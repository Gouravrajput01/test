// // app/page.js
// // SOFTMAX IT INTERN EXAM SYSTEM - FIXED: 2 VIOLATIONS = LOCK + LIVE VIDEO
...
//   const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSf2z8_UdwymKTtlhYh0cizlbF1ETvX9wIY6i7wAr3EETtGYww/viewform?usp=header";
...
//         // CRITICAL FIX: Lock exam at 2 violations
//         if (savedLocked === 'true' || violations >= 2) {
//           setExamState(prev => ({
//             ...prev,
//             examLocked: true,
//             showForm: false,
//             showInstructions: false,
//             lockReason: savedReason || 'Maximum violations (2)'
//           }));
...
//         // FIX: Ensure video plays and displays correctly
...
//   // Increment Violation - FIX: Lock at 2 violations
...
//     console.log(`🚨 Violation detected: ${reason}, Count: ${newCount}/2`);
...
//     showWarning(`⚠️ VIOLATION ${newCount}/2: ${reason}`, 3000);

//     // FIX: Lock at 2 violations (not 3)
//     if (newCount >= 2) {
//       lockExam('Maximum violations (2)');
//     }
//   };
...
//     if (examState.violationCount >= 2 || examState.examLocked) {
...
//                 <div>
//                   <p style={{ color: '#5d739b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Position</p>
//                   <p style={{ color: '#f0f4ff', fontSize: '1rem', fontWeight: '600' }}>💻 IT Intern</p>
//                 </div>
//                 <div>
//                   <p style={{ color: '#5d739b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Mode</p>
//                   <p style={{ color: '#f0f4ff', fontSize: '1rem', fontWeight: '600' }}>🌍 Remote / Hybrid</p>
//                 </div>
//                 <div>
//                   <p style={{ color: '#5d739b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Duration</p>
//                   <p style={{ color: '#f0f4ff', fontSize: '1rem', fontWeight: '600' }}>⏳ 6 Months</p>
//                 </div>
//                 <div>
//                   <p style={{ color: '#5d739b', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Stipend</p>
//                   <p style={{ color: '#4ade80', fontSize: '1rem', fontWeight: '700' }}>💰 ₹6,000/month</p>
//                 </div>
//               </div>
//               <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: '1px solid #1a2536' }}>
//                 <p style={{ color: '#fbbf24', fontSize: '0.85rem', fontWeight: '600' }}>
//                   🚀 Full-Time Opportunity: Up to ₹6 LPA based on performance
//                 </p>
//               </div>
//             </div>
...
//             {/* Rules - Updated for 2 violations */}
//             <div style={{
//               background: '#0a0f18',
//               padding: '20px',
//               borderRadius: '16px',
...
//                 }}>
//                   <span style={{ fontSize: '1.2rem' }}>🚫</span>
//                   <span><strong>No Tab Switching</strong> - <span style={{ color: '#dc2626', fontWeight: 'bold' }}>2 violations = Locked</span></span>
//                 </li>
//                 <li style={{ 
//                   padding: '10px 0', 
//                   display: 'flex',
...
//                 }}>
//                   <span style={{ fontSize: '1.2rem' }}>🔒</span>
//                   <span><strong>No Exiting Fullscreen</strong> - <span style={{ color: '#dc2626', fontWeight: 'bold' }}>2 violations = Locked</span></span>
//                 </li>
//               </ul>
//             </div>

//             {/* Violation Warning - Updated for 2 violations */}
//             {examState.violationCount > 0 && (
//               <div style={{
//                 background: examState.violationCount >= 1 ? 'rgba(220,38,38,0.15)' : 'rgba(251,191,36,0.1)',
//                 padding: '12px',
//                 borderRadius: '12px',
//                 marginTop: '16px',
//                 border: examState.violationCount >= 1 ? '2px solid #dc2626' : '1px solid #fbbf24'
//               }}>
//                 <p style={{
//                   color: examState.violationCount >= 1 ? '#dc2626' : '#fbbf24',
//                   fontSize: '0.9rem',
//                   textAlign: 'center',
//                   fontWeight: '700'
//                 }}>
//                   ⚠️ Previous Violations: {examState.violationCount}/2
//                   {examState.violationCount >= 1 && ' ⚠️ ONE MORE VIOLATION WILL LOCK THE EXAM!'}
//                 </p>
//               </div>
//             )}
//           </div>
...
//             right: 0,
//             zIndex: 9999,
//             background: examState.violationCount >= 1 
//               ? 'rgba(220, 38, 38, 0.98)' 
//               : 'rgba(251, 191, 36, 0.98)',
//             color: examState.violationCount >= 1 ? 'white' : '#0a0e14',
//             padding: '16px 20px',
//             textAlign: 'center',
//             fontWeight: 'bold',
//             fontSize: '1.1rem',
...
//               marginTop: '4px'
//             }}>
//               ⚠️ Violations: {examState.violationCount}/2
//               {examState.violationCount >= 1 && ' ⚠️ ONE MORE VIOLATION WILL LOCK THE EXAM!'}
//             </span>
//           </div>
//         )}
...
//                 fontWeight: '700'
//               }}>
//                 Violations: {examState.violationCount}/2
//               </span>
//             </div>
//           </div>
...
//         {/* Live Video Box - FIX: Always visible and working during exam */}
//         <div style={{
//           position: 'fixed',
//           bottom: '24px',
//           right: '24px',
...
// // // app/page.js
// // // THANKS FOR THE TEST - CLEAN PAGE
...
// //               fontSize: '0.75rem'
// //             }}>
// //               Softmax Technologies & IT Services
// //             </p>
// //             <p style={{
// //               color: '#3d4a5f',
// //               fontSize: '0.7rem',
// //               marginTop: '4px'
// //             }}>
// //               Technology • Consulting • AI • Growth
// //             </p>
// //           </div>
// //         </div>
...
// //                 }}>
// //                   <span style={{ fontSize: '1.2rem' }}>🚫</span>
// //                   <span><strong>No Tab Switching</strong> - 2 violations = Locked</span>
// //                 </li>
// //                 <li style={{ 
// //                   padding: '10px 0', 
// //                   display: 'flex',
...
// //                 }}>
// //                   <span style={{ fontSize: '1.2rem' }}>🔒</span>
// //                   <span><strong>No Exiting Fullscreen</strong> - 2 violations = Locked</span>
// //                 </li>
// //               </ul>
// //             </div>
...
// //                   {examState.violationCount >= 2 && ' ⚠️ DANGER: 2 violations will lock exam!'}
// //                 </p>
// //               </div>
// //             )}
// //           </div>
